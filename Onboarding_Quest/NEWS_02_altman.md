...
그는 이에 대해 "인간의 창의성은 무한합니다. 우리는 이를 통해 새로운 직업과 새로운 할 일을 찾을 것입니다" 라고 덧붙였다. (더 자세한 이날 인터뷰 내용은 아래 [영상](https://youtu.be/540vzMlf-54)을 참고하면 된다.)  
...
- - - -
회고: 마크다운으로 이렇게 긴 글을 작성해보는 것은 처음이라 조금 어색하고 낯설지만, 어렵지 않아 조금만 더 연습한다면 보다 더 쉽게 활용할 수 있을 것 같다. 이번 기회에 나도 깃허브를 예쁘고 보기 좋게 정리해보고 싶다. 또한 기사를 읽다보니 이전에 업무를 하며 생성형 인공지능을 사용할 경험이 있었는데, 인간인 나의 역량에 대해 고민해보게 되었다. 근데 앞으로도 발전하는 분야이며, 창시자(?)조차 두려움을 느낀다는 점에서 어떻게 이 분야에서 윤리를 지키며 이롭게 사용할 수 있을까 혹은 내가 발전시킬 수 있을까 고민하게 된다.
